...
@interface MainPageViewController () <NavViewDelegate, UITableViewDataSource, UITableViewDelegate, IIViewDeckControllerDelegate, SimpleCamDelegate, G8TesseractDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
...
@property (nonatomic, weak) IBOutlet UIView *viewDate;      // 顶部视图
@property (nonatomic, weak) IBOutlet UILabel *lblYear;      // 年
@property (nonatomic, weak) IBOutlet UILabel *lblMonth;     // 月
@property (nonatomic, weak) IBOutlet UILabel *lblNumber;    // 发票总数
@property (nonatomic, weak) IBOutlet UILabel *lblTotal;     // 总金额

@property (nonatomic, weak) IBOutlet UIView *viewType;      // 底部视图
@property (nonatomic, weak) IBOutlet UILabel *lblRejected;  // 被拒
@property (nonatomic, weak) IBOutlet UILabel *lblApproved;  // 通过
@property (nonatomic, weak) IBOutlet UILabel *lblApproving; // 审核中
@property (nonatomic, weak) IBOutlet UILabel *lblPending;   // 待定
...
//    self.viewType.layer.borderWidth = 1;
//    self.viewType.layer.borderColor = [[UIColor colorWithRed:(CGFloat)251/255 green:(CGFloat)194/255 blue:(CGFloat)182/255 alpha:1] CGColor];
