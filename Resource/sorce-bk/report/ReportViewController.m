...
- (void)initView
{
    ...
    self.viewSectionHead.backgroundColor = [UIColor colorWithRed:(CGFloat)247/255 green:(CGFloat)97/255 blue:(CGFloat)29/255 alpha:1];
...
- (void)moreAction
{
    if (self.viewSearchHeight.constant == 0)
    {
        self.viewSearchHeight.constant = 44;
