...
- (void)viewDidLoad {
    ...
    if (self.registerFlag == YES)
    {
        ...
        [self.navView.btnBack setTitle:@"取消" forState:UIControlStateNormal];
        ...
        [self.navView.btnBack.titleLabel setFont:[UIFont systemFontOfSize:16]];
...
- (int)checkContent
{
    ...
    if (self.textfieldPhone.text.length > 20 && self.textfieldPhone.text.length < 4)
    {
        return 11;
    }
