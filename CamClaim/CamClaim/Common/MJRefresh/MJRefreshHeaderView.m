...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        NSString *strValue = locatizedString(@"mjrefresh_header_pull");
        self.pullToRefreshText = strValue;
        
        strValue = locatizedString(@"mjrefresh_header_release");
        self.releaseToRefreshText = strValue;
        
        strValue = locatizedString(@"mjrefresh_header");
        self.refreshingText = strValue;
    }
    return self;
}
...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day]) { // 今天
        ...
        //NSString *strValue = locatizedString(@"mjrefresh_today");
        //formatter.dateFormat = [NSString stringWithFormat:@"%@ HH:mm", strValue];
    ...
    NSString *strValue = locatizedString(@"mjrefresh_update_time");
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@：%@", strValue, time];
}
