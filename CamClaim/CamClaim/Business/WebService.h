...
// 搜索公司
static NSString *const API_USER_SEARCHCOMPANY = @"/sales/user/getCompanyInfoByName";

// 邀请公司相关活动内容及邀请码
static NSString *const API_USER_INVITECOMPANYFORCODE = @"/sales/user/invitationphone";

// 邀请公司
static NSString *const API_USER_INVITECOMPANY = @"/sales/user/newInvitationByCompany";
...
#pragma mark - 消息中心
// 个人邀请记录
static NSString *const API_USER_INVITERECORD = @"/sales/user/getCodeByUserid";
