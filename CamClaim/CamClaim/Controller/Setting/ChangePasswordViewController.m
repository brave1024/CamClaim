...
@property (nonatomic, strong) IBOutlet UILabel *lblPswOld;
@property (nonatomic, strong) IBOutlet UILabel *lblPswNew;
@property (nonatomic, strong) IBOutlet UILabel *lblPswAgain;
    ...
    if (status != 0)
    {
        switch (status) {
            case 1: {
                ...
                NSString *strTip = locatizedString(@"psw_old_nil");
                [self toast:strTip];
                break;
            }
            case 2: {
                ...
                NSString *strTip = locatizedString(@"psw_new_nil");
                [self toast:strTip];
                break;
            }
            case 3: {
                ...
                NSString *strTip = locatizedString(@"psw_repeat_nil");
                [self toast:strTip];
                break;
            }
            case 4: {
                ...
                NSString *strTip = locatizedString(@"psw_old_length_invalild");
                [self toast:strTip];
                break;
            }
            case 5: {
                ...
                NSString *strTip = locatizedString(@"psw_new_length_invalild");
                [self toast:strTip];
                break;
            }
            case 6: {
                ...
                NSString *strTip = locatizedString(@"psw_repeat_length_invalild");
                [self toast:strTip];
                break;
            }
            case 7: {
                ...
                NSString *strTip = locatizedString(@"psw_notsame");
                [self toast:strTip];
                break;
            }
            case 8: {
                ...
                NSString *strTip = locatizedString(@"psw_old_error");
                [self toast:strTip];
                break;
            }
            default:
...
{
    NSString *strValue = locatizedString(@"psw_old");
    self.lblPswOld.text = strValue;
    
    strValue = locatizedString(@"psw_new");
    self.lblPswNew.text = strValue;
    
    strValue = locatizedString(@"psw_repeat");
    self.lblPswAgain.text = strValue;
    
    strValue = locatizedString(@"input_old_psw");
    [self.textfieldPswOld setPlaceholder:strValue];
    
    strValue = locatizedString(@"input_new_psw");
    [self.textfieldPswNew setPlaceholder:strValue];
    
    strValue = locatizedString(@"input_repeat_new_psw");
    [self.textfieldPswAgain setPlaceholder:strValue];
    
    strValue = locatizedString(@"change_password");
...
- (int)checkContent
{
    ...
    if (self.textfieldPswOld.text.length > 12 && self.textfieldPswOld.text.length < 6)
    {
        return 4;
    }
    
    if (self.textfieldPswNew.text.length > 12 && self.textfieldPswNew.text.length < 6)
    {
        return 5;
    }
    
    if (self.textfieldPswAgain.text.length > 12 && self.textfieldPswAgain.text.length < 6)
    {
        return 6;
    }
