...
- (NSMutableArray *)arrayList
{
    if (_arrayList == nil)
    {
        NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Setting_Final_V1" ofType:@"plist"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    NSString *strValue = locatizedString(@"setting");
    
    UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(10, 20, 108, 30)];
