...
@interface HotelDetailViewController () <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
...
/*
 ...
 [clientcompany]:
 [cartype]:
 [imgurl]: /var/mobile/Containers/Data/Application/18AE110B-ABAB-4AD7-...
 [store]: 希腊人酒店
 [usetime]: 2015/10
...
- (void)initData
{
    ...
    self.txtfieldDateNumber.text = nil;
    ...
    self.txtfieldDateNumber.text = self.item.days;
    ...
    {
        NSLog(@"imgurl:%@", self.item.imgurl);
        
//        UIImage *img = [UIImage imageWithContentsOfFile:self.item.imgurl];
//        if (img != nil)
//        {
