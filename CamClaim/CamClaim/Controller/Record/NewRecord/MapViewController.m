...
- (void)viewDidLoad {
    ...
    NSString *strValue = locatizedString(@"map_position");
...
- (void)moreAction
{
    ...
    if (self.hasGetCurrent == NO)
    {
        ...
        NSString *strValue = locatizedString(@"long_press_select");
        [self toast:strValue];
...
{
    NSString *strValue = locatizedString(@"long_press_select");
    self.lblTip.text = [NSString stringWithFormat:@"[%@]", strValue];
...
- (void)longPress:(UIGestureRecognizer*)gestureRecognizer
{
    ...
    if (self.startFlag == YES)
    {
        NSString *strValue = locatizedString(@"position_selected");
        NSString *strFlag = locatizedString(@"position_start");
        
        //title = @"已选位置 [起点]";
        title = [NSString stringWithFormat:@"%@ [%@]", strValue, strFlag];
    }
    else
    {
        NSString *strValue = locatizedString(@"position_selected");
        NSString *strFlag = locatizedString(@"position_end");
