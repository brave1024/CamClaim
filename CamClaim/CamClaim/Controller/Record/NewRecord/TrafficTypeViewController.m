...
@interface TrafficTypeViewController () <UITableViewDataSource, UITableViewDelegate, MKMapViewDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
...
- (void)viewDidLoad {
    ...
    //self.navView.lblTitle.text = @"Traffic";
...
//        [self.btnTraffic setBackgroundImage:img forState:UIControlStateNormal];
    }
