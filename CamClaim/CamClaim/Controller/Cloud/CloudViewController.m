...
//    [self.btnBaidu setBackgroundImage:imgBtn_ forState:UIControlStateHighlighted];
    [self.btnBaidu setImage:[UIImage imageNamed:@"icon_Cloud_Baidu"] forState:UIControlStateNormal];
    [self.btnBaidu setImage:[UIImage imageNamed:@"icon_Cloud_Baidu"] forState:UIControlStateHighlighted];
...
//    [self.btnOnedrive setBackgroundImage:imgBtn_ forState:UIControlStateHighlighted];
    [self.btnOnedrive setImage:[UIImage imageNamed:@"icon_Cloud_Onedrive"] forState:UIControlStateNormal];
    [self.btnOnedrive setImage:[UIImage imageNamed:@"icon_Cloud_Onedrive"] forState:UIControlStateHighlighted];
...
//    [self.btnDropbox setBackgroundImage:imgBtn_ forState:UIControlStateHighlighted];
    [self.btnDropbox setImage:[UIImage imageNamed:@"icon_Cloud_Dropbox"] forState:UIControlStateNormal];
    [self.btnDropbox setImage:[UIImage imageNamed:@"icon_Cloud_Dropbox"] forState:UIControlStateHighlighted];
                ...
                [ODClient authenticatedClientWithCompletion:^(ODClient *client, NSError *error){
                    ...
                    else
                    {
                        ...
                        dispatch_async(dispatch_get_main_queue(), ^(){
                            ...
                            NSString *strValue = locatizedString(@"onedrive_fail_cancel");
                            [self toast:strValue];
                        });
                    }
                }];
