...
- (void)initView
{
    ...
    //self.viewContent.backgroundColor = [UIColor colorWithRed:(CGFloat)248/255 green:(CGFloat)127/255 blue:(CGFloat)31/255 alpha:1];
    
    //self.textview.text = @"改善个人及公司生产力的小工具\n移动报销 无缝对接\n工作生活新体验";
    self.textview.text = @"工作生活新體驗\n移動報銷 無縫對接\n\nEmail: support@camclaim.com";
    self.lblVersion.text = [NSString stringWithFormat:@"CamClaim V%@", kCurrentVersion];
...
{
    NSString *strValue = locatizedString(@"version_content");
    self.textview.text = strValue;
}
