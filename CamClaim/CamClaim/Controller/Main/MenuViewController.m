...
//    self.reportVC = [[ReportViewController alloc] initWithNibName:@"ReportViewController" bundle:nil];
//    self.noticeVC = [[NoticeViewController alloc] initWithNibName:@"NoticeViewController" bundle:nil];
...
- (void)logoutAction
{
    ...
    [self.viewDeckController closeLeftViewAnimated:YES completion:^(IIViewDeckController *controller, BOOL success) {
        ...
        // 连同pincode一起删除
        //[userDef removeObjectForKey:kPinCode];
        [userDef synchronize];
...
- (void)jumpToLogout
{
    ...
    NSString *strTip = locatizedString(@"logout_tip");
    NSString *strCancel = locatizedString(@"cancel");
    NSString *strDone = locatizedString(@"done");
    
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:strTip message:nil delegate:self cancelButtonTitle:strCancel otherButtonTitles:strDone, nil];
    [alert show];
}
