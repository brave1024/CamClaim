...
#define kBaseUrl @"http://115.29.105.23:8080"       // 正式服务器
...
// 更新ViewController数据的通知
#define kUpadteViewControllerData    @"upadteViewControllerData"

// 更新Touch ID验证界面
#define kTouchID4Setting            @"settingForTouchID"

// 微信充值操作完成后返回到当前app时传递过来充值成功与否的状态,需发通知到充值界面
#define kWechatPayStatus             @"wechatPayStatus"
...
// 腾讯信鹆push key
// 酷发巴巴彩票appstore<线上产品>
#define XGAccessId 2200044276
#define XGAccessKey @"IR8682HQQG8B"

// 未登录用户使用信鹆push注册设备时默认设置的别名
#define kPushAccountForNotLogin @"Kufa88_iOS_Push"
